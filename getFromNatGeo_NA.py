...
def getFromNatGeo():
	parameters = {'source': 'national-geographic', 'sortBy': 'top', 'apiKey': mc.newsapi_key}
	...
	outerDict = {}
	outerDict['NationalGeographic'] = resultList
	return outerDict

# print(json.dumps(getFromNatGeo(), indent=4, sort_keys=True))
